...
const HtmlText = forwardRef<HTMLDivElement, IHtmlText>(
  ({ html, id, width, height }, ref) => {
    ...
    function cleanQuillHtml(html: string): string {
      ...
      doc
        .querySelectorAll<HTMLElement>("[class*='ql-align-']")
        .forEach((el) => {
          const classList = el.classList;
          ...
          if (classList.contains("ql-align-center")) {
            ...
            //Осталась проблема с правым выравниванием
      ...
      doc
        .querySelectorAll<HTMLElement>("li[data-list='bullet']")
        .forEach((li) => {
